...
<html>
    ...
    <body>
        ...
        <div class="container"  style="margin-right: 2px; margin-left: 15%;  font-size: 20px; ">
                            ...
                            <tbody><!--
                                <c:forEach var="u" items="${listS}">
                                    -->                            <tr>                               
                                        ...
                                        <td><a  href="updateSetting?sid=${u.setting_id}"><button type="button" class="btn btn_detail ">Detail
                                                </button> </a>  
                                        </td>
                                    </tr><!--
                                </c:forEach>                           
