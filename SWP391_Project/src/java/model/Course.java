...
public class Course {
    ...
    public Course(int course_id, String name, String title, double original_price, double sale_price, String brief_infor, int cate_id, int sale_id, String image, Date course_date, int user_id) {
        this.course_id = course_id;
        this.name = name;
        this.title = title;
        this.original_price = original_price;
