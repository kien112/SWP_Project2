...
public class User {
    ...
    public User(int user_id, String full_name, String email, String password, boolean gender, String address, String phone_number, String verification_code, boolean is_verified, Role role, boolean status, int role_id) {
